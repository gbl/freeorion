#ifndef _SpecialsListWnd_h_
#define _SpecialsListWnd_h_

#include "CUIWnd.h"
#include "../network/Message.h"
#include <GG/ListBox.h>

class SpecialsListBox;

class SpecialsListWnd : public CUIWnd {
public:
    //! \name Structors //@{
    SpecialsListWnd(const std::string& config_name);
...
private:
    ...
    std::shared_ptr<SpecialsListBox>  m_specials_list;
};
